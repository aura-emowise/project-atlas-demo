import { FaBook, FaBalanceScale, FaBrain, FaAtom, FaDna, FaChartLine } from 'react-icons/fa';
import { GiRazor } from "react-icons/gi";

// Наш новый, структурированный массив данных
export const atlasData = [
  ...
  },
  {
    ...
    checkpoints: [
      { id: '2.1', title: 'Thermodynamics & Entropy', icon: FaAtom, concept: 'Coming Soon...', lab: null },
      { id: '2.2', title: 'Evolution by Natural Selection', icon: FaDna, concept: 'Coming Soon...', lab: null },
    ]
  },
  {
    id: 3,
    ...
    checkpoints: [
      { id: '3.1', title: 'Supply & Demand', icon: FaChartLine, concept: 'Coming Soon...', lab: null },
      { id: '3.2', title: 'Cognitive Biases Revisited', icon: FaBrain, concept: 'Coming Soon...', lab: null }
    ]
  }
];

// Полный код для лаб, чтобы было легко копировать
